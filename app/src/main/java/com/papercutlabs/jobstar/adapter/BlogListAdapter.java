...
public class BlogListAdapter extends BaseAdapter {
    ...
    public BlogListAdapter(Context mContext, ArrayList<Blog> blogs) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Set title and Image
        holder.tv_title.setText(blogs.get(position).getTitle());
        holder.tv_author.setText(blogs.get(position).getSource());
        Glide.with(holder.iv_blog.getContext()).load(blogs.get(position).getUrlImage()).centerCrop().override(50, 50).dontTransform().into(holder.iv_blog);
